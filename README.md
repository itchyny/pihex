# pihex &emsp; [![Build Status](https://api.travis-ci.org/itchyny/pihex.svg?branch=master)](https://travis-ci.org/itchyny/pihex) [![Latest Version](https://img.shields.io/crates/v/pihex.svg)](https://crates.io/crates/pihex)
